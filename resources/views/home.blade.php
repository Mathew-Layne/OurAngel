<x-header>
    ...
    <div class="w-full h-screen bg-[url('/img/foodbg1.jpg')] bg-no-repeat bg-cover bg-center">
        <nav class="h-[10%] drop-shadow-lg flex justify-between py-6 px-5 w-full bg-indigo-900 text-white">
